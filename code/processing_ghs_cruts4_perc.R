...
df_diffs <- lapply(dfs,function(x){
  as.data.frame(x <- cbind(
                x[,11]<-((x[,11]-x[,23])/x[,23])*100,x[,12]<-((x[,12]-x[,23])/x[,23])*100, # replace values with diffs from avg
                x[,13]<-((x[,13]-x[,23])/x[,23])*100,x[,14]<-((x[,14]-x[,23])/x[,23])*100,
                x[,15]<-((x[,15]-x[,23])/x[,23])*100,x[,16]<-((x[,16]-x[,23])/x[,23])*100,
                x[,17]<-((x[,17]-x[,23])/x[,23])*100,x[,18]<-((x[,18]-x[,23])/x[,23])*100,
                x[,19]<-((x[,19]-x[,23])/x[,23])*100,x[,20]<-((x[,20]-x[,23])/x[,23])*100,
                x[,21]<-((x[,21]-x[,23])/x[,23])*100,x[,22]<-((x[,22]-x[,23])/x[,23])*100,
                x[,23]))
  }
)
...
# generate output
cld <- generate(cld)
names(cld) <-c("cld01_mdperc","cld02_mdperc","cld03_mdperc","cld04_mdperc",
               "cld05_mdperc","cld06_mdperc","cld07_mdperc","cld08_mdperc",
               "cld09_mdperc","cld10_mdperc","cld11_mdperc","cld12_mdperc")
dtr <- generate(dtr)
names(dtr) <-c("dtr01_mdperc","dtr02_mdperc","dtr03_mdperc","dtr04_mdperc",
               "dtr05_mdperc","dtr06_mdperc","dtr07_mdperc","dtr08_mdperc",
               "dtr09_mdperc","dtr10_mdperc","dtr11_mdperc","dtr12_mdperc")
pet <- generate(pet)
names(pet) <-c("pet01_mdperc","pet02_mdperc","pet03_mdperc","pet04_mdperc",
               "pet05_mdperc","pet06_mdperc","pet07_mdperc","pet08_mdperc",
               "pet09_mdperc","pet10_mdperc","pet11_mdperc","pet12_mdperc")
pre <- generate(pre)
names(pre) <-c("pre01_mdperc","pre02_mdperc","pre03_mdperc","pre04_mdperc",
               "pre05_mdperc","pre06_mdperc","pre07_mdperc","pre08_mdperc",
               "pre09_mdperc","pre10_mdperc","pre11_mdperc","pre12_mdperc")
tmn <- generate(tmn)
names(tmn) <-c("tmn01_mdperc","tmn02_mdperc","tmn03_mdperc","tmn04_mdperc",
               "tmn05_mdperc","tmn06_mdperc","tmn07_mdperc","tmn08_mdperc",
               "tmn09_mdperc","tmn10_mdperc","tmn11_mdperc","tmn12_mdperc")
tmp <- generate(tmp)
names(tmp) <-c("tmp01_mdperc","tmp02_mdperc","tmp03_mdperc","tmp04_mdperc",
               "tmp05_mdperc","tmp06_mdperc","tmp07_mdperc","tmp08_mdperc",
               "tmp09_mdperc","tmp10_mdperc","tmp11_mdperc","tmp12_mdperc")
tmx <- generate(tmx)
names(tmx) <-c("tmx01_mdperc","tmx02_mdperc","tmx03_mdperc","tmx04_mdperc",
               "tmx05_mdperc","tmx06_mdperc","tmx07_mdperc","tmx08_mdperc",
               "tmx09_mdperc","tmx10_mdperc","tmx11_mdperc","tmx12_mdperc")
vap <- generate(vap)
names(vap) <-c("vap01_mdperc","vap02_mdperc","vap03_mdperc","vap04_mdperc",
               "vap05_mdperc","vap06_mdperc","vap07_mdperc","vap08_mdperc",
               "vap09_mdperc","vap10_mdperc","vap11_mdperc","vap12_mdperc")
wet <- generate(wet)
names(wet) <-c("wet01_mdperc","wet02_mdperc","wet03_mdperc","wet04_mdperc",
               "wet05_mdperc","wet06_mdperc","wet07_mdperc","wet08_mdperc",
               "wet09_mdperc","wet10_mdperc","wet11_mdperc","wet12_mdperc")
...
save(NGA_panel, file = "outputs/panel_unif_perc.RData")
